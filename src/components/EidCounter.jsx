...
export default function EidCounter() {
  ...
  return (
    <>
    <div className=' border-t-4 border-t-green-600  w-full h-full  rounded-2xl  ' >
        <div className='bg-[#121A2D]  w-full  h-full  rounded-lg '>
            <div className='flex h-100  gap-6 justify-center items-center  flex-col'>
